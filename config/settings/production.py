...
# NOTE: PaaS providers like Render block outbound SMTP on ports 25, 465, and 587
# by default. Ensure your email port/provider is unblocked or use HTTP API / port 2525.
